...
class Network:
    def __init__(self):
        ...
        self.cnn_fc = (self.input_size[0]/self.division_factor) * (self.input_size[0]/self.division_factor) * self.nf_3
        #Fully connected
        self.fc_1 = 512
        self.fc_2 = 512
    ...
    def build(self):
        ...
        h_pool2_flat = tf.reshape(h_pool3, [-1, int(self.cnn_fc)])

        W_fc1 = weight_variable([int((self.input_size[0] / self.division_factor) * (self.input_size[0] / self.division_factor) * self.nf_3), self.fc_1])
