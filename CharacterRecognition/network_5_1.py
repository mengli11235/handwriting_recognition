...
class Network:
    def __init__(self):
        ...
        self.rf_5 = 4
        self.nf_5 = 128
        # fifth _1 _convolution
        self.rf_6 = 1
        self.nf_6 = 64

        self.cnn_fc = 1 * self.nf_6
        #Fully connected
        self.fc_1 = 512
        self.fc_2 = 512
    ...
    def build(self):
        ...
        # Convolution layer 6
        W_conv6 = weight_variable([self.rf_6, self.rf_6, self.nf_5, self.nf_6])
        b_conv6 = bias_variable([self.nf_6])

        h_conv6 = tf.nn.relu(conv2d(h_pool5, W_conv6) + b_conv6)

        # Fully connected layer 1
        h_pool2_flat = tf.reshape(h_conv6, [-1, int(self.cnn_fc)])
